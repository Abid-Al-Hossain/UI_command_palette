...
export default function Page() {
  const [state, setState] = useState<CommandPaletteState>(DEFAULT_COMMANDPALETTE_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Command Palette Studio" controls={controls} preview={output} /></AppShell>;
}
