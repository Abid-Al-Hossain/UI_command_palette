...
export default function AccessibilitySection({ state, update }: Props) {
  return <SectionCard title="Accessibility" subtitle="Accessibility controls for native command generation.">
...
<Input label="Result count label" value={state.resultLabel ?? ""} onChange={(value) => update("resultLabel", value)} /></div>
    </SectionCard>;
}
