...
export default function BasicsSection({ state, update }: Props) {
  return <SectionCard title="Basics" subtitle="Basics controls for native command generation.">
...
<Input label="Preview query" value={state.query ?? ""} onChange={(value) => update("query", value)} /></div>
    </SectionCard>;
}
